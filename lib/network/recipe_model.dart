...
class APIRecipeQuery {
  // Note also that the first call is a factory method. That’s because you need
  //a class-level method when you’re creating the instance, while you use the
  //other method on an object that already exists.
...
//with the string q. The rest of the fields look in JSON just like their names
//here.
  @JsonKey(name: 'q')
  String query;
  int from;
  ...
  // The required annotation says that these fields are mandatory when creating
  //a new instance.
  APIRecipeQuery({
    required this.query,
    required this.from,
